...
parser.add_argument('--model_dir', default='experiments/baseline/resnet50',
                    help="Directory containing params.json")
parser.add_argument('--dataset', default='experiments/test/',
...
def load_data():
    ...
    trainset = Cub2010(root = args.dataset,is_train=True, transform=transform_train)
